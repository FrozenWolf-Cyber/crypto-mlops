...
with DAG(
    ...
    past_news_task = BashOperator(
        ...
        bash_command="PYTHONPATH=..:$PYTHONPATH python -m utils.articles_runner.past_news_scrape",
    ...
    trl_maker_task = BashOperator(
        ...
        bash_command="PYTHONPATH=..:$PYTHONPATH python -m utils.serve.trl_onnx_maker",
                on_execute_callback=log_start,
                on_success_callback=log_success,
                on_failure_callback=log_failure,
    )
    ...
    trl_inference_task = BashOperator(
        ...
        bash_command="PYTHONPATH=..:$PYTHONPATH python -m utils.serve.trl_inference",
                on_execute_callback=log_start,
                on_success_callback=log_success,
                on_failure_callback=log_failure,
    )
